            ...
            <div class="min-h-screen py-6 px-4 md:py-12 md:px-8 font-sans antialiased text-slate-900">
                ...
                class="relative pl-8 py-10 before:absolute before:left-0 before:top-0 before:h-full before:w-1 before:bg-emerald-500/20">
                    ...
                    <div id="paso1" class="ml-8 mb-12 relative">
                        <div class="absolute -left-[78px] top-1 w-8 h-8 bg-emerald-500 rounded-full border-4 border-white dark:border-gray-900 shadow-[0_0_15px_rgba(16,185,129,0.5)] flex items-center justify-center text-[14px] font-black text-white">1</div>
                    ...
                    <div id="paso2" class="ml-8 mb-12 relative">
                        <div class="absolute -left-[78px] top-1 w-8 h-8 bg-emerald-500 rounded-full border-4 border-white dark:border-gray-900 shadow-[0_0_15px_rgba(16,185,129,0.5)] flex items-center justify-center text-[14px] font-black text-white">2</div>
                    ...
                    <div id="paso3" class="ml-8 relative">
                        <div class="absolute -left-[78px] top-1 w-8 h-8 bg-emerald-500 rounded-full border-4 border-white dark:border-gray-900 shadow-[0_0_15px_rgba(16,185,129,0.5)] flex items-center justify-center text-[14px] font-black text-white">3</div>
