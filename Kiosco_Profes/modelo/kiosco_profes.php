                                                ...
                                                <div class="relative z-10">
                                                    <div class="flex flex-col gap-1">
                                                        ...
                                                        <div class="flex items-center gap-4 group/number cursor-pointer">
                                                            <p class="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-mono font-medium tracking-[0.1em] sm:tracking-[0.15em] md:tracking-normal lg:tracking-[0.15em] text-white/90 group-hover:text-emerald-50 transition-colors">
