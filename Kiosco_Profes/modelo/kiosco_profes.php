...
?>
    ...
    <div class="relative mx-auto text-center max-w-5xl overflow-hidden bg-white/50 dark:bg-gray-800 p-6 md:p-8 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-sm">
        ...
        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
            <div class="flex-shrink-0 bg-white/50 dark:bg-gray-800 p-3  rounded-xl shadow-md">
                <img src="../assets/logo2.png" alt="Logo" class="h-16 md:h-20 w-auto bg-transparent">
            </div>
    ...
    <div class="flex flex-col md:flex-row justify-end m-4 gap-4">
        <!-- Botón para abrir el modal de Nuevo Banner -->
        <button type="button" onclick="document.getElementById('modalSlide').classList.remove('hidden')"
            class="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-2xl shadow-lg transition-all active:scale-95 flex items-center justify-center gap-2">
